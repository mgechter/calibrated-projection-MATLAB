function [theta_keep,EI_keep]  = KMS_36_drawpoints(theta_hash,q,r_max,r_min, y_supp, n_supp, n_x_supp, d, p_a, p_e, rho_l, bs_classyears,dmodel,LB,UB,A,b,KMSoptions)
%% Code description
...
while flag_while
    ...
    Eimprovement = @(theta) KMS_37_EI_value(theta,q,theta_hash, y_supp, n_supp, n_x_supp, d, p_a, p_e, rho_l, bs_classyears,dmodel,KMSoptions);
